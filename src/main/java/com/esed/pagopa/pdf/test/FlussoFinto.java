...
public class FlussoFinto extends Flusso {
	...
	public FlussoFinto() {
//		esempio su una propriet� semplice
...
// 		cos� per il resto dei dati necessari del gruppo
//		fai la stessa cosa per i DatiAnagrafici (il poro cristo vessato dalle istituzioni)
//		e per Bollettino, magari prova a mettere pi� di qualche bollettino cos� proviamo l'uso dei vari modelli 
